...
Code for the creation of a Table in latex with the composition (in weights) of the doppelganger of Japan.
"""
...
Weights=pd.read_pickle(ppj("OUT_TABLES", 'Weights_Japan.pkl'))
...
#print(tabulate(df, showindex="never", headers="firstrow", tablefmt="latex", floatfmt=".3f"))
